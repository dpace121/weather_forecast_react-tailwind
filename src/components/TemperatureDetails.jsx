...
units,
    ...
    const horizontalDetails =[
        ...
        {
            id:3, Icon:MdKeyboardArrowDown, title:"Low", value:`${temp_min.toFixed()}°`
  ...
  return (
    ...
    <div className="flex flex-row items-center justify-center spaxe-x-10 text-sm py-3">
        {
            horizontalDetails.map(({id,Icon,title,value}) =>(
                ...
                <p>{`${title}`}:<span className="font-medium ml-1">{value}</span>
                </p>
                </div>
        ))}
